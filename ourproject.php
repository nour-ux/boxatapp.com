    ...
    <div class="wrapper">
        ...
        <div class="slider-area">
            <div id="ensign-nivoslider" class="slides">   
                <img src="images/slider/slider1.png" alt="" title="#htmlcaption1"/>
                <img src="images/slider/slider2.png" alt="" title="#htmlcaption2"/>
				<img src="images/slider/slider2.png" alt="" title="#htmlcaption2"/> 
                        ...
                        <div class="col-md-offset-5 col-md-7 slider-height">
                            <div class="slide-text">
                                <div class="cap-title cap-main-title wow bounceInDown mb-35 text-uppercase text-white" data-wow-duration="0.5s" data-wow-delay="0s">
                                    <h2><strong>بوكسات المطاعم</strong></h2>
                                </div>
                ...
                <div class="container slider-height">
                    <div class="row slider-height">
                        <div class="col-md-offset-5 col-md-7 slider-height">
                            <div class="slide-text">
                                <div class="cap-title cap-main-title wow bounceInDown mb-35 text-uppercase text-white" data-wow-duration="0.5s" data-wow-delay="0s">
                                    <h2><strong>بوكسات الطهي</strong></h2>
                                </div>
                                <div class="cap-sub-title cap-main-title wow bounceInDown mb-40 text-uppercase text-white" data-wow-duration="1s" data-wow-delay="0s">
                                    <h2>حسب الدراسات </h2>
                                </div>
                                <div class="cap-sub-title wow bounceInDown mb-30 text-white" data-wow-duration="1.5s" data-wow-delay="0s">
                                    <p>مرفق طريقة التحضير</p>
                                </div>
                                <div class="cap-shop wow bounceInUp" data-wow-duration="2s" data-wow-delay=".5s">
                                    <a href="#" class="button extra-small text-uppercase">
                                        <span>Shop now</span>
                ...
                <div class="container slider-height">
                    <div class="row slider-height">
                        <div class="col-md-offset-5 col-md-7 slider-height">
                            <div class="slide-text">
                                <div class="cap-title cap-main-title wow bounceInDown mb-35 text-uppercase text-white" data-wow-duration="0.5s" data-wow-delay="0s">
                                    <h2><strong>بوكسات التوفير المنزلي</strong></h2>
                                </div>
                                <div class="cap-sub-title cap-main-title wow bounceInDown mb-40 text-uppercase text-white" data-wow-duration="1s" data-wow-delay="0s">
                                    <h2>يؤمن احتاجاتكم</h2>
                                </div>
                                <div class="cap-sub-title wow bounceInDown mb-30 text-white" data-wow-duration="1.5s" data-wow-delay="0s">
                                    <p>حسب دراسات سلوك المستخدم</p>
                                </div>
                                <div class="cap-shop wow bounceInUp" data-wow-duration="2s" data-wow-delay=".5s">
                                    <a href="#" class="button extra-small text-uppercase">
                                        <span>Shop now</span>
                    ...
                    <div class="row">
                        <div class="col-sm-5">
                            <div class="banner-img banner-hover mb-30">
                                <a href="#" class="b-img">
                                    <img src="images/banner/Untitled-1.jpg" alt="">
                                </a>
                            ...
                            <div class="tab-menu section-title section-title  mb-30">  
                                ...
                                <ul class="nav nav-tabs" role="tablist">          
                                    <li role="presentation" class="first-item active">
                                        <a href="#arrival" aria-controls="arrival" role="tab" data-toggle="tab">بوكسات المطاعم</a>
                                    </li>
                                    <li role="presentation">
                                        <a href="#sale" aria-controls="sale" role="tab" data-toggle="tab">بوكسات الوصفة الكامله</a>
                                    </li>
                                    <li role="presentation">
                                        <a href="#featured" aria-controls="featured" role="tab" data-toggle="tab">بوكسات التوفير العائلية</a>
                                    </li>
                                </ul>
                            </div> 
                        </div>
                                ...
                                <div class="col-md-3 col-sm-4">
                                    <div class="single-product mb-40">
                                        <div class="product-img-content mb-20">
                                            <div class="product-img">
                                                <a href="product-details.html">
                                                    <img src="images/product/BR1.png" alt="">
                                                </a>
                                            </div>
                                        ...
                                        <div class="product-content text-center text-uppercase">
		                                  ...
		                                  <?php
		                                    include("connect.php");
			                           		$val=$conn->query("select * from idex1 where cat=1 ORDER BY id DESC LIMIT 3 ");
 				                        	While($row = $val->fetch())
				                            		{
					                            	echo "<div>";
				                               		echo "<img src='";
				                             		echo $row['img']; 
						                     		echo "' alt='cam1' style='width:100%'>";
						                     		echo "<div><h2>";
						                     		echo $row['name'];
						                     		echo "</h2>";
						                     		echo $row['price'];
						                     		echo "RS/Hour</p>";
						                     		echo "</div></div>";
													echo "<div class='product-action text-center'> ";
                                                    echo "<a href="#" title="Quick view" data-toggle="modal" data-target="#productModal">";
                                                    echo "<i class='zmdi zmdi-eye'></i>";
                                                    echo "</a>";
                                                    echo "<a href="#" title="Add to cart">";
                                                    echo "<i class='zmdi zmdi-shopping-cart'></i>"; 
                                                echo "</a>";
                                                echo "<a href="#" title="Add to Wishlist">";
